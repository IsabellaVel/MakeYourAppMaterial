...
//                mPhotoContainerView.setTranslationY((int) (mScrollY - mScrollY / PARALLAX_FACTOR));
    ...
    private void bindViews() {
        ...
        android.support.v7.widget.Toolbar toolbar = mRootView.findViewById(R.id.toolbar_meta_details);
        mPhotoView = mRootView.findViewById(R.id.pic_full);
        TextView mBookText = mRootView.findViewById(R.id.article_body);
